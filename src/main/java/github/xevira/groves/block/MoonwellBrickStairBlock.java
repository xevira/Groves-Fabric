...
public class MoonwellBrickStairBlock extends StairsBlock implements BlockEntityProvider {
    public MoonwellBrickStairBlock(BlockState baseBlockState, Settings settings) {

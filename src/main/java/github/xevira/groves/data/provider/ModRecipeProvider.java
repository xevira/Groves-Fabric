...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    private void generateLunarCycleShapeless(RecipeExporter exporter, RecipeCategory category, List<Block> phases)
    {
        for(int i = 0; i < phases.size(); i++)
        {
            ...
            ShapelessRecipeJsonBuilder.create(category, block2)
                    .input(block1.asItem())
    ...
    private void generateLunarCycleStonecutting(RecipeExporter exporter, RecipeCategory category, Block input, List<Block> phases)
    {
        phases.forEach(block -> offerStonecuttingRecipe(exporter, category, input.asItem(), block.asItem()));
    }
    ...
    private void generateLunarPhaseWaxing(RecipeExporter exporter, RecipeCategory category, List<Block> phases)
    {
        phases.forEach(unwaxed -> {
            ...
            waxed.ifPresent(block -> ShapelessRecipeJsonBuilder.create(category, block)
                    .input(unwaxed)
    ...
    private void generateMoonstoneRecipes(RecipeExporter exporter)
    {
        ...
        offerCrackingRecipe(exporter, Registration.CRACKED_MOONSTONE_BRICKS_ITEM, Registration.MOONSTONE_BRICKS_ITEM);
        offerSlabRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, Registration.MOONSTONE_BRICK_SLAB_ITEM, Registration.MOONSTONE_BRICKS_ITEM);
        offerWallRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, Registration.MOONSTONE_BRICK_WALL_ITEM, Registration.MOONSTONE_BRICKS_ITEM);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, Registration.MOONSTONE_BRICKS_ITEM, Registration.MOONSTONE_BRICK_SLAB_ITEM, 2);
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, Registration.MOONSTONE_BRICKS_ITEM, Registration.MOONSTONE_BRICK_STAIRS_ITEM);
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, Registration.MOONSTONE_BRICKS_ITEM, Registration.MOONSTONE_BRICK_WALL_ITEM);
        offerStonecuttingRecipe(exporter, RecipeCategory.BUILDING_BLOCKS, Registration.MOONSTONE_BRICKS_ITEM, Registration.CRACKED_MOONSTONE_BRICKS_ITEM);
        generateLunarCycleStonecutting(exporter, RecipeCategory.BUILDING_BLOCKS, Registration.MOONSTONE_BRICKS_BLOCK, CHISELED_MOONSTONE);
    }

    @Override
    public void generate(RecipeExporter exporter) {
        generateMoonstoneRecipes(exporter);
    }
}
